...
*   **Tests IHM :** J'ai fait des tests IHM avec l'aide de Gemini pour vérifier que les éléments de la page Home étaient affichés ou encore que le Memory s'initialisait bien et cela fonctionne particulièrement bien!
